...
export function CustomersTableFloatingBar({
  ...
  const [showDeleteCustomersDialog, setShowDeleteCustomersDialog] =
  ...
  return (
    <>
      <DeleteCustomerDialog
        open={showDeleteCustomersDialog}
        onOpenChange={setShowDeleteCustomersDialog}
        clientes={rows.map((row) => row.original)}
        showTrigger={false}
